...
-   **Metody**:
    -   Veřejnou metodu pro přidání hodnocení (int 0–5). Metoda přijme v argumentu nové hodnocení a aktualizuje vlastnost `Hodnoceni` tak, aby v ní stále bylo aktuální průměrné hodnocení.
